...
#' values, whereas swfscDAS randpicks files contain one line for each continuous
#' effort section. See \code{\link{das_chop_equallength}} for more details about
#' the swfscDAS randpicks format. This function 'converts' a randpicks data
#' frame generated by segchopr to a data frame that meets the swfscDAS randpicks
#' format requirements
#'
#' @return
#' Data frame with one line for each continuous effort section in
#' \code{x.segdata}, and two columns: \code{effort_section} and \code{randpicks}
#'
#' @export
