#' Read DAS file
#'
#' Read one (or more - todo) fixed-width DAS text file(s) generated by WinCruz into a data frame,
#'   where each line is data for a specific event
#'
#' @param file one or more DAS data filenames
...
#'
#' @details Reads/parses DAS data into columns.
...
#'   }
#'
#'   See the "TODO" vignette for more information
#'
