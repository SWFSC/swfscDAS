...
This document introduces you to the swfscDAS package, and specifically its functionality and workflow. This package is intended to standardize and streamline processing of DAS data. It  was designed for shipboard DAS data generated using the [WinCruz software](https://github.com/SWFSC/WinCruz-2.0) from the Southwest Fisheries Science Center. However, the DAS files and the `swfscDAS` package are and can be used by others, e.g. to process decades of NOAA Fisheries survey data. 
